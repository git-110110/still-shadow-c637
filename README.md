...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/still-shadow-c637#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/still-shadow-c637
```

A live public deployment of this template is available at [https://still-shadow-c637.templates.workers.dev](https://still-shadow-c637.templates.workers.dev)
